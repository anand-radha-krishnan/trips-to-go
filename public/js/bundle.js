      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)(res.data.status, 'Logged in successfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error while logging out');
        case 10:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new maptilersdk.Map({
    container: 'map',
    // container's id or the HTML element in which the SDK will render the map
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)(res.data.status, "".concat(type.toUpperCase(), " updated successfully"));
          }
          _context.next = 10;
          break;
        case 7:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable*/
var maptiler = document.getElementById('map');
...
if (maptiler) {
  var locations = JSON.parse(maptiler.dataset.locations);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _updateSettings.updateUser)({
